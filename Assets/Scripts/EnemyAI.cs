...
public class EnemyAI : MonoBehaviour, IAI
{
    ...
    private Vector2Int lastPlayerGridPosition; // Last grid position of the player
    ...
    public void MoveTowardsPlayer(Vector2Int playerPosition)
    {
        ...
        Vector2Int bestTile = currentGridPosition; // Best tile to move towards
        float closestDistance = float.MaxValue; // Closest distance to the player
    ...
    private IEnumerator MoveToTile(Vector2Int targetTile)
    {
        ...
        Vector3 targetPosition = new Vector3(targetTile.x, 0.6f, targetTile.y); // Adjust the y value to place the enemy on top of the grid
